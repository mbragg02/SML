 ...
 *
 * @author Keith Mannock, Michael Bragg & David North
 */
@Data
public class Machine {
    ...
    public static void main(String[] args) {
        ...
        if (args == null || args.length == 0) {
            System.out.println("Please supply a filename of a SML program file as a program argument, such as the included \"program.text\"");
        } else {
